...
T2W.CS_CZ.DICTIONARY = {	
	ones		:[
					[ "", "jedna", "dva", "tri", "ctyri", "pet", "šest", "sedm", "osm", "devet" ],
					[ "", "jedentisíc", "dvatisíce", "tritisíce", "ctyritisíce", "pettisíc", "šesttisíc", "sedmtisíc", "osmtisíc", "devettisíc" ],
					[ "", "jedenmilión", "dvamilióny", "trimilióny", "ctyrimilióny", "petmiliónu", "šestmiliónu", "sedmmiliónu", "osmmiliónu", "devemiliónu"]					
				],
	teens		:[ "deset", "jedenáct", "dvanáct", "trináct", "ctrnáct", "patnáct", "šestnáct", "sedmnáct", "osmnáct", "devatenáct" ],
	tens		:[ "", "", "dvacet", "tricet", "ctyricet", "padesát", "šedesát", "sedmdesát", "osmdesát", "devadesát" ],
	hundreds	:[ "", "sto", "dveste", "trista", "ctyrista", "petset", "šestset", "sedmset", "osmset", "devetset" ],
